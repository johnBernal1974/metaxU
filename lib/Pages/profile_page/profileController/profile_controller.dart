...
class ProfileController{
  ...
  late StreamSubscription<DocumentSnapshot<Object?>> _clientInfoSuscription = const Stream<DocumentSnapshot<Object?>>.empty().listen((_) {});
  ...
  void dispose() {
    if (_clientInfoSuscription != null) {
